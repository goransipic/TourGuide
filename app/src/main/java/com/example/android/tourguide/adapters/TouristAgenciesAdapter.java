 ...
 */
public class TouristAgenciesAdapter extends BaseAdapter {

    ArrayList<Tourist> mReachArrayList;
    Context mContext;

    public TouristAgenciesAdapter(Context context, ArrayList<Tourist> mReachArrayList) {
